                      ...
                      <?php
                        ...
                        if(isset($_GET['buttonPesquisar']) and $_GET['txtpesquisar'] != ''){
                          $nome = $_GET['txtpesquisar'] . '%';
                           ...
                           $query = "select u.id, u.nome, u.usuario, u.senha, u.cargo, u.id_funcionario from usuarios as u INNER JOIN funcionarios as f ON u.id_funcionario = f.id where u.nome LIKE '$nome'  order by u.nome asc"; 

                        }else{
                         $query = "select u.id, u.nome, u.usuario, u.senha, u.cargo, u.id_funcionario from usuarios as u INNER JOIN funcionarios as f ON u.id_funcionario = f.id order by u.nome asc"; 
                        }
