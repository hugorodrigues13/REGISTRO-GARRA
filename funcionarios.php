              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title"> Registro de Alunos</h4>
                  </div>
                  <div class="card-body">
         ...
         <!-- Modal content-->
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Registro de Alunos</h4>
...
$query = "INSERT into funcionarios (nome, cpf, graduacao, dataGra, endereco, cargo, data, filiacao, numRegistro) VALUES ('$nome', '$cpf', '$graduacao', '$dataGra',  '$endereco', '$cargo',  curDate(),  '$filiacao', '$numRegistro' )";
         ...
         <!-- Modal content-->
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                <label for="id_produto">Graduação</label>
                <input type="text" class="form-control mr-2" name="txtgraduacao" id="txtgraduacao" placeholder="Graduação" value="<?php echo $res_1['graduacao']; ?>"required>
              </div>
              <div class="form-group">
                <label for="id_produto">Data Graduação</label>
                <input type="text" class="form-control mr-2" name="txtdataGra" id="txtdataGra" placeholder="Data da Graduação" value="<?php echo $res_1['dataGra']; ?>"required>
              </div>
              <div class="form-group">
                <label for="quantidade">Endereço</label>
              ...
              <div class="form-group">
                <label for="id_produto">Data Nascimento</label>
                <input type="text" class="form-control mr-2" name="txtdata" id="txtdata" placeholder="Data de Nascimento" value="<?php echo $res_1['data']; ?>"required>
              </div>
              <div class="form-group">
                <label for="id_produto">Filiacao</label>
                <input type="text" class="form-control mr-2" name="txtfiliacao" id="txtfiliacao" placeholder="Filiação" value="<?php echo $res_1['filiacao']; ?>"required>
              </div>
              <div class="form-group">
                <label for="id_produto">Registro</label>
                <input type="text" class="form-control mr-2" name="txtregistro" id="txtregistro" placeholder="Numero de Registro" value="<?php echo $res_1['numRegistro']; ?>"required>
              </div>
               <div class="form-group">
                <label for="fornecedor">Cargo</label>
...
$query_editar = "UPDATE funcionarios set nome = '$nome', cpf = '$cpf', graduacao = '$graduacao', dataGra = '$dataGra', endereco = '$endereco', data = '$data', filiacao = '$filiacao', numRegistro = '$numRegistro', cargo = '$cargo' where id = '$id' ";
